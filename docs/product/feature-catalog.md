...
| Feature | Product state | Release rule |
|---|---|---|
| Voice activation and bounded device actions | Implemented behind the Advanced surface for controlled cohorts | Closed-track/limited-beta only; exclude from broad Play Store claims |
...
| Offline STT, TTS, and voice conversation mode | Planned | On-device quality, power, interruption, privacy, language, and device-tier evidence |
...
5. General-availability voice claims
