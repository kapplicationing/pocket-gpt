...
3. Voice is a production opt-in available to compatible users; retained 24-hour and multi-OEM qualification controls reliability/support claims, not feature availability.
