...
5. Voice is limited-beta/closed-track only.
...
| DR-006 | Voice scope | Docs can describe voice as post-MVP-only or generally available | High | Product + Release Ops | Use limited-beta/closed-track language consistently |
...
1. Rebuilt the feature catalog around implemented, limited-beta, post-MVP, and
   claim-safe states.
