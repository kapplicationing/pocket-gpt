...
>
> Performance and model availability depend on your device and chosen model. This controlled MVP supports one-image contextual help, not broad document or multi-image analysis. Voice remains a limited beta for controlled cohorts and is not part of this public listing claim set.
...
- Voice: limited-beta closed-cohort behavior; excluded from the public listing copy and screenshots
